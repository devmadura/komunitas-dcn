        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="h-9 w-9 hover:bg-green-500 hover:text-white hover:border-green-500"
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              variant="outline"
              size="icon"
              className="h-9 w-9 hover:bg-primary hover:text-blue-300 hover:border-primary"
          ...
          <TooltipContent>{copied ? "Tersalin!" : "Salin Link"}</TooltipContent>
        </Tooltip>
      </div>
    </TooltipProvider>
  );
